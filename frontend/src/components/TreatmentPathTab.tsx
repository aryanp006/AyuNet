              ...
              <button
                ...
                className={`w-full text-left px-4 py-2.5 rounded-xl text-sm font-medium transition-all ${
                  selected === d
                    ...
                    : "bg-slate-800 text-slate-400 border border-white/10 hover:border-orange-500/50"
                }`}
              >
                {d}
              </button>
        ...
        {result?.pathway?.pathways && (
          <div className="flex-1 overflow-y-auto space-y-3">
            ...
            {result.pathway.pathways.map((p: any, i: number) => (
              <div
                key={i}
                className="bg-slate-900/60 backdrop-blur border border-white/10 rounded-xl p-4"
              >
                ...
                <div className="grid grid-cols-3 gap-2 text-xs">
                  ...
                  <div>
                    ...
                    <span className="text-amber-400 font-bold ml-1">{p.cost_tier}</span>
                  </div>
                  <div>
                    <span className="text-slate-500">Duration:</span>
                    <span className="text-slate-300 font-bold ml-1">{p.duration}</span>
                  </div>
                </div>
              </div>
            ))}
